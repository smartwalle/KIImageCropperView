...
@interface KIImageCropperView() {
    KIImageCropperMaskView  *_cropperMaskView;
...
- (KIImageCropperMaskView *)cropperMaskView {
    if (_cropperMaskView == nil) {
        _cropperMaskView = [[KIImageCropperMaskView alloc] initWithFrame:self.bounds];
        [_cropperMaskView setBackgroundColor:[UIColor clearColor]];
        [_cropperMaskView setUserInteractionEnabled:NO];
        [self addSubview:_cropperMaskView];
        
        [self setBackgroundColor:[UIColor lightGrayColor]];
    }
    [self bringSubviewToFront:_cropperMaskView];
    return _cropperMaskView;
}
...
- (void)layoutSubviews {
    ...
    [[self cropperMaskView] setFrame:self.bounds];
    [[self cropperMaskView] setMaskSize:[self maskViewSize]];
